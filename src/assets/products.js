...
import product4 from "./products/product_4.png";
import product5 from "./products/product_5.png";
import product6 from "./products/product_6.png";
import product7 from "./products/product_7.png";
...
const products = [
  {
    ...
    description:
      "This Classic Denim Jacket is a wardrobe essential that offers both style and comfort. Crafted from durable, high-quality denim, it features a timeless design with a modern twist. Perfect for layering over any outfit, this jacket will keep you warm during the cooler months and make a bold fashion statement. The versatile blue shade complements any color, and its classic fit suits various body types, making it an easy choice for everyday wear.",
    oldPrice: 3499,
    newPrice: 2999,
  },
  {
    ...
    description:
      "Our Casual Chino Pants combine comfort with a sharp, refined look. Made from breathable cotton fabric, these chinos are perfect for both casual outings and semi-formal events. They feature a slim fit that provides a modern silhouette, while maintaining ease of movement. Whether paired with a t-shirt for a laid-back look or dressed up with a button-up shirt, these chinos are versatile enough to fit any occasion.",
    oldPrice: 4499,
    newPrice: 3999,
  },
  {
    ...
    description:
      "This Premium Cotton T-Shirt is the epitome of comfort and style. Made from ultra-soft cotton fabric, it feels gentle against the skin while offering breathability throughout the day. The minimalist design ensures that it can be easily paired with any outfit, making it a versatile choice for everyday wear. Available in a range of colors, this t-shirt is a must-have for those looking to update their basics with a touch of luxury.",
    oldPrice: 2499,
    newPrice: 1999,
  },
  {
    ...
    description:
      "Stay warm and stylish with our Cozy Knit Sweater. This sweater is made from a soft, high-quality knit fabric that offers both warmth and breathability, making it perfect for chilly days. The relaxed fit provides ultimate comfort, while the simple yet elegant design allows you to pair it with any bottom, from jeans to skirts. Available in multiple colors, this sweater is perfect for layering or wearing on its own for a classic, cozy look.",
    oldPrice: 5499,
    newPrice: 4999,
  },
  {
    ...
    description:
      "Our Lightweight Bomber Jacket is designed to keep you stylish and comfortable, without weighing you down. The sleek bomber style features ribbed cuffs and collar, providing a casual yet trendy look. Made from durable yet breathable materials, it’s perfect for those in-between weather days. Whether worn with jeans for a relaxed vibe or dressed up with trousers for a night out, this jacket will be your go-to outerwear for versatile style.",
    oldPrice: 2999,
    newPrice: 2499,
  },
  {
    ...
    title: "Trendy Hoodie",
    description:
      "This Trendy Hoodie is your go-to piece for laid-back style and comfort. Made from soft, plush fabric, it’s designed to keep you cozy while looking effortlessly cool. Featuring a drawstring hood and a spacious kangaroo pocket, it combines practical features with modern streetwear appeal. The relaxed fit and minimalistic design make it easy to pair with your favorite jeans or leggings, making it ideal for everyday wear or casual outings.",
    oldPrice: 3999,
    newPrice: 3499,
  },
  {
    ...
    description:
      "Our High-Waisted Skinny Jeans offer a flattering fit that hugs your curves while providing comfort and flexibility. The stretchy denim fabric ensures a perfect fit, while the high-waisted design elongates the legs for a sleek, modern silhouette. These jeans are versatile enough to dress up or down – pair them with a blouse for a chic look, or with a casual t-shirt for a relaxed vibe. Available in various washes to suit your personal style.",
    oldPrice: 4999,
    newPrice: 4499,
  },
  {
    ...
    description:
      "Make a statement with our Elegant Midi Dress, designed to bring out your inner elegance. Made from luxurious, breathable fabric, this dress drapes beautifully over your body, giving you both comfort and style. The flattering A-line silhouette and subtle details like the V-neckline make this dress perfect for formal events or evening outings. Available in classic shades, this midi dress is the perfect blend of sophistication and grace.",
    oldPrice: 5999,
    newPrice: 5499,
  },
  {
    ...
    description:
      "This Classic Blazer is an essential piece for anyone who appreciates a sharp, tailored look. Made from high-quality wool, it features a structured fit that enhances your silhouette while providing ultimate comfort. Whether paired with trousers for a formal meeting or with jeans for a smart-casual look, this blazer will elevate any outfit. Available in a range of colors, it’s a timeless wardrobe staple that exudes confidence and sophistication.",
    oldPrice: 7499,
    newPrice: 6499,
  },
  {
